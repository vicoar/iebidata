...
(function($) {
  ...
  $.chromeframebar.defaults = {
    ...
    'text': {
	  ...
	  'es-AR': 'Internet Explorer necessita instalar un plugin para visualizar esta página corretamente. Click aqui para continuar...',
	  'es-ES': 'Internet Explorer necessita instalar un plugin para visualizar esta página corretamente. Click aqui para continuar...',
